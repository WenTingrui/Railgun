...
float umotor_x=1500;//舵机输出量大小取值0~6000
...
//		eet_y[et_len-1]=target_y-TARGET_Y;
		...
		//增量式PID控制
		umotor_x=umotor_x+((KP+KI+KD)*etx-(KP+2*KD)*etx_1+KD*etx_2)/1000.0;
//		umotor_y=umotor_y+((KP+KI+KD)*ety-(KP+2*KD)*ety_1+KD*ety_2)/1000000.0;
